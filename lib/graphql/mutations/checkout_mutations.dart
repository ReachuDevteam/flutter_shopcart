...
mutation CreateCheckout(\$cartId: String!) {
  ...
  static const String updateCheckoutMutation = '''
   mutation UpdateCheckout(\$checkoutId: String!, \$buyerAcceptsTermsConditions: Boolean, \$buyerAcceptsPurchaseConditions: Boolean, \$billingAddress: AddressArgs, \$paymentMethod: String, \$cancelUrl: String, \$successUrl: String, \$email: String, \$status: String, \$shippingAddress: AddressArgs) {
  Checkout {
    UpdateCheckout(checkout_id: \$checkoutId, buyer_accepts_terms_conditions: \$buyerAcceptsTermsConditions, buyer_accepts_purchase_conditions: \$buyerAcceptsPurchaseConditions, billing_address: \$billingAddress, payment_method: \$paymentMethod, cancel_url: \$cancelUrl, success_url: \$successUrl, email: \$email, status: \$status, shipping_address: \$shippingAddress) {
      buyer_accepts_purchase_conditions
      buyer_accepts_terms_conditions
      created_at
      updated_at
